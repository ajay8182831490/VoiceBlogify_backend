...
const planFeatures = [
    ...
    { plan: 'BUSINESS', featureName: 'Total Blogs Allowed', description: 'Maximum number of blogs a user can create.', limit: 60 },
    { plan: 'BUSINESS', featureName: 'Audio Recording Length', description: 'Maximum audio length for recordings in minutes.', limit: 90 },
    { plan: 'BUSINESS', featureName: 'Audio Recording File Size', description: 'Maximum file size for audio recordings in MB.', limit: 500 },
];
